        ...
        with torch.no_grad():
            ...
            # Multi-stage inference
                ...
                while difference > diff_threshold:
                    ...
                    # if plot_img:
                    #     inference_images.extend([x_t, x_pred,x_0_cache])
...
if __name__ == "__main__":
    ...
    # noise_steps = [400,500,600,700]
    noise_steps = [[200], [250], [300]]
    gaussian_kernel_sizes = [7, 11, 15, 17]
    anomaly_thresholds = [0.1, 0.2, 0.3, 0.4]
